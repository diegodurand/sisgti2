...
<head>
    ...
    <title>Reporte Accesorios</title>
    <style>
        /* Estilos generales */
        body {
...
<body>
    ...
    @foreach ($equipos as $equipo)
        <h4>{{ $equipo->marca }} {{ $equipo->modelo }} - Laboratorio: {{ $equipo->laboratorio->nombre }}</h4>
    ...
    @endforeach
        <div class="footer">
            <p>Responsable de sistema de gestión de inventarios SISGTI &copy; Hebert Illa Quispe </p>
        </div>
</body>
</html>
